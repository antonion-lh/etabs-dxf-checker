...
def run_curriculum_audit(etabs_dict: dict, cfg: Any = None, results_data: Any = None) -> list[dict]:
    ...
    results.append({
        ...
        "status": st_31,
        "finding": f_31,
        "rule": "Provjeriti kolika je površina nosivih zidova u odnosu na tlocrt zgrade. Preporučeni MINIMUM je Aw/A ≥ 2.5–3.5% po svakom smjeru (X i Y); veći udio zidova dodatno povećava krutost i nije nedostatak. Provjera posmičnih naprezanja: dozvoljeno do 0.2 - 0.4 MPa za slabo armirane, max 2.0 MPa za armirane zidove (Anđelić).",
        "bullets": [
            "Površina nosivih zidova u smjeru X: preporučeni minimum Awx / A_tlocrta ≥ 2.5–3.5%",
            "Površina nosivih zidova u smjeru Y: preporučeni minimum Awy / A_tlocrta ≥ 2.5–3.5%",
            "Veći postotak zidova od minimuma je povoljan (veća krutost) i ne kažnjava se",
